...
class Page extends \AppBundle\Entity\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'id', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'slug', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'name', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'title', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'sequence', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'content', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'footer', '' . "\0" . 'AppBundle\\Entity\\Page' . "\0" . 'description');
        }
